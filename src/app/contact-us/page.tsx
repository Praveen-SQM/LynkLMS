      ...
      <div className="h-full w-full flex xl:flex-row flex-col items-center justify-center 3xl:gap-[221px] xl:gap-[156px] sm:gap-[48px] gap-[42px]">
        ...
        >
          <div className="flex flex-col gap-3 xl:flex hidden">
            <h2 className="text-bold text-[20px] leading-[27.3px] text-[#FFFFFF]">
              Contact Us.
            </h2>
                ...
                return (
                  <div key={index} className="flex items-center gap-6">
                    ...
                    <div className="flex flex-col gap-2">
                      <p className="font-semibold text-[16px] leading-[26px] text-[#FFFFFF]">
                        {CardItem?.title}
                      </p>
                      <p className="font-normal text-[16px] leading-[22px] text-[#FFFFFF]">
                        {CardItem?.number}
                      </p>
                    </div>
                  </div>
        ...
        >
          <div className="sm:bg-white rounded-[24px] sm:p-6 p-0 sm:shadow-lg">
            <h2 className="max-w-[276px] font-medium text-[22px] leading-[32px] text-[#131313] mb-[40px] sm:block hidden">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="xl:mb-8 mb-6">
                <div className="flex items-center justify-between">
                  ...
                  <div className="font-normal text-[12px] leading-3 text-[#131313] sm:block hidden">
                    {messageCount}/1000
                  </div>
                </div>
                <textarea
            ...
            return (
              <div key={index} className="flex items-start sm:gap-6 gap-1">
                ...
                <div className="flex flex-col sm:gap-2 gap-1">
                  <p className="font-semibold sm:text-[16px] sm:leading-[26px] text-[14px] leading-[19px] sm:text-[#FFFFFF] text-[#000000]">
                    {CardItem?.title}
                  </p>
                  <p className="font-normal sm:text-[16px] sm:leading-[22px] text-[14px] leading-[19px] sm:text-[#FFFFFF] text-[#000000]">
                    {CardItem?.number}
                  </p>
                </div>
              </div>
