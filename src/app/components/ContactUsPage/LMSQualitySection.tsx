...
const LMSQualitySection = () => {
  ...
  return (
    <div className="w-full 3xl:pt-[120px] 3xl:pb-[120px] xl:pt-[42px] xl:pb-[218px] sm:pt-[24px] sm:pb-[92px] pt-[42px] pb-[42px] flex flex-col items-center justify-center lg:px-0 px-4 3xl:gap-[72px] xl:gap-[54px] sm:gap-8 gap-7">
      ...
      <div className="relative w-full max-w-6xl lg:px-0 px-4 overflow-hidden sm:block hidden">
        {/* Prev Button */}
        <button
      ...
      <div className="items-center xl:gap-2 sm:gap-[4.7px] lg:px-0 px-4 sm:flex hidden">
        {dots?.map((_,index)=>{
            return(
