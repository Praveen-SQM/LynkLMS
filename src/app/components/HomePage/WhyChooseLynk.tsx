            ...
            {features?.map((feature, index) => (
              ...
              >
                <section className="flex flex-col xl:gap-[37px] 3xl:gap-[54px] gap-[30px]">
                  ...
                  <div>
                    <h1 className="font-family-Manrope font-bold xl:text-[20px] 3xl:text-[28px] xl:leading-[28px] text-[16px] leading-[21.9px] xl:tracking-[-0.28px] mb-[12px] 3xl:mb-[23px]">
                      {feature.title}
                    </h1>
                    <div className="flex flex-col xl:gap-[12px] 3xl:gap-[18px] gap-[8.64px] mb-[20px]">
                      {feature.points.map((point, index) => (
                        <p
                          key={index}
                          className="flex items-center justify-start font-Manrope font-semibold text-[14px] 3xl:text-[20px] tracking-[-0.28px] text-[#1D1A27CC]"
                        >
