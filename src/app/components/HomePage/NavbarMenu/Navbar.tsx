          ...
          >
            <div className="flex flex-col justify-between h-full w-full">
              <motion.div className="flex flex-col mt-24 space-y-8 font-[600] text-gray-900">
                {/* Fix: Wrap motion around Link instead of nesting motion.a inside Link */}
              ...
              <motion.div variants={mobileLinkVariants} className="mb-4">
                <Link
                  href="/contact-us"
                  onClick={() => setIsMobileMenuOpen(false)}
                  className="border-2 bg-[#6559FF] border-white text-white text-center w-full font-[600] p-3 px-6 rounded-lg hover:bg-white hover:text-[#6559FF] transition-colors block 3xl:text-[18px] 3xl:leading-[100%] 3xl:py-[10px]"
                >
                  Book a Demo
                </Link>
              </motion.div>
