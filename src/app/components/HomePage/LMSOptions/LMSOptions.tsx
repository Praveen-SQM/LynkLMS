...
const LMSOptions = () => {
    ...
    const lmsFeatures = [
        ...
        },
        {
            ...
            description: "Register employees, track progress, and manage certificates and invoices."
        },
        {
            icon: courseIcon,
            title: "Course Management",
            description: "Create, manage, and track courses with pricing and categories."
        },
        {
            icon: quizIcon,
            title: "Quiz Management",
            description: "Customize quizzes with timers, limits, and passing percentages."
        },
        {
            icon: reportingIcon,
            title: "Reporting & Analytics",
            description: "Generate reports on revenue, registrations, and training progress."
        },
        {
            icon: automationIcon,
            title: "Automation",
        ...
        },
        {
            ...
            description: "Efficiently manage teams and departments for seamless collaboration."
        },
        {
            icon: rolesIcon,
            title: "Roles and Permissions",
            description: "Control user access with customizable roles and permissions."
        },
        {
            icon: categoryIcon,
            title: "Category Management",
            description: "Organize content into categories for easy navigation and access."
        }
    ]
                    ...
                    return(
                        <div key={index} className="flex flex-col sm:rounded-[20px] rounded-[12px] xl:p-10 p-4 xl:gap-5 gap-2 bg-[#ffffff]">
                            <div className="xl:w-[32px] xl:h-[32px] h-6 w-6">
                                <Image src={feature?.icon} alt="image" width={32} height={32} className="w-full h-full object-cover"/>
                            </div>
                            <div className="flex flex-col 3xl:gap-3 xl:gap-2 gap-1">
                                <p className="font-bold 3xl:text-[22px] 3xl:leading-[30px] xl:text-[18px] xl:leading-[24.6px] text-[14px] leading-[19.12px] text-[#1D1A27]">{feature?.title}</p>
                                <p className="font-normal 3xl:text-[18px] 3xl:leading-[25.2px] xl:text-[14px] xl:leading-[23.8px] text-[14px] leading-[19.6px] text-[#1D1A27CC]">{feature?.description}</p>
                            </div>
                        </div>
                    )
                })}
